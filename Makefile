...
CORE_OBJS = ds4.o ds4_float_compare.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_metal.o ds4_layer_pack.o
...
CORE_OBJS = ds4.o ds4_float_compare.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_cuda.o ds4_layer_pack.o $(MMQ_OBJS)
CPU_CORE_OBJS = ds4_cpu.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
...
strix-halo:
	$(MAKE) -B ds4 ds4-server ds4-bench ds4-eval ds4-agent \
		CORE_OBJS="ds4.o ds4_float_compare.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_rocm.o ds4_rocm_compat.o ds4_rocm_unavailable.o ds4_layer_pack.o" \
...
ds4.o: ds4.c ds4.h ds4_ssd.h ds4_distributed.h ds4_float_compare.h ds4_gpu.h
	$(CC) $(CFLAGS) -c -o $@ ds4.c
