...
CORE_OBJS = ds4.o family_repair.o first_divergence_capture.o ds4_float_compare.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_metal.o ds4_layer_pack.o
...
CORE_OBJS = ds4.o family_repair.o first_divergence_capture.o ds4_float_compare.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_cuda.o ds4_layer_pack.o $(MMQ_OBJS)
CPU_CORE_OBJS = ds4_cpu.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
...
tests/test_family_repair_contracts.o: tests/test_family_repair_contracts.c family_repair.h
	$(CC) $(CFLAGS) -I. -c -o $@ $<

tests/test_family_repair_contracts: tests/test_family_repair_contracts.o family_repair.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)

test-family-repair-contracts: tests/test_family_repair_contracts
	./tests/test_family_repair_contracts
...
test: ds4_test ds4_agent_test ds4-eval q4k-dot-test mxfp4-dot-test \
	tests/test_first_divergence tests/test_family_repair_contracts tests/test_layer_pack tests/test_engine_mgpu_placement tests/test_gpu_args \
